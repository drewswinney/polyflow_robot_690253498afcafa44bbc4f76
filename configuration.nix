...
let
  user      = "admin";
  password  = "password";
  hostname  = "690253498afcafa44bbc4f76";
  homeDir   = "/home/${user}";
  ...
  rosidlTypesupportPython = rosPkgs."rosidl-typesupport-python";
  rosidlGeneratorPy = rosPkgs."rosidl-generator-py";
  rosidlDefaultRuntime = rosPkgs."rosidl-default-runtime";
